...
with open("legendaries.txt","r") as file:
    legendary_list = file.read()

with open("mythics.txt","r") as file:
...
def update_title():
    ctypes.util.find_library(f"Pokemon Caught: {num_pokemon} || Shinies: {num_shinies} || Legendaries: {num_legendaries} || Mythics: {num_mythics} || Fled: {num_fled}")
